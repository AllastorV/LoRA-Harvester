...
def run_self_test() -> dict:
    ...
    No model downloads. Install requirements-dev.txt in the application environment first.
    Qt-only tests skip when PyQt5 is unavailable; core dependencies remain required."""
    try:
        env = {
            **os.environ,
            "PYTHONUTF8": "1",
