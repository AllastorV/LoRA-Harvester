...
class DropZoneFrame(QFrame):
    ...
    def __init__(self, placeholder: str, parent=None):
        ...
        theme.bind_style(self, theme.drop_zone_frame_default)

        inner = QHBoxLayout(self)
        inner.setContentsMargins(10, 2, 10, 2)

        self._lbl = QLabel(placeholder)
        theme.bind_style(self._lbl, theme.label_transparent)
    ...
    def dragEnterEvent(self, event: QDragEnterEvent):
        if event.mimeData().hasUrls():
            ...
            if result:
                ...
                theme.bind_style(self, theme.drop_zone_frame_active)
                return
        event.ignore()
...
class CharacterSortPage(QWidget):
    ...
    def init_ui(self):
        ...
        theme.bind_style(self.input_drop, lambda self=self: self._drop_zone_card_style())
        ...
        theme.bind_style(src_icon, lambda: f"font-size: 28px; color: {theme.TEXT_MUTED}; background: transparent; border: none;")
        src_title_lbl = QLabel(get_text('source_images_label', self.lang)); src_title_lbl.setAlignment(Qt.AlignCenter)
        theme.bind_style(src_title_lbl, lambda: f"color: {theme.TEXT_PRIMARY}; font-size: {theme.fs(15)}; font-weight: 600; background: transparent; border: none;")
        src_desc = QLabel(get_text('source_images_desc', self.lang))
        src_desc.setAlignment(Qt.AlignCenter); src_desc.setWordWrap(True)
        theme.bind_style(src_desc, lambda: f"color: {theme.TEXT_SECONDARY}; font-size: {theme.fs(12)}; background: transparent; border: none;")
        self._src_path_lbl = QLabel(get_text('no_folder_selected', self.lang))
        self._src_path_lbl.setAlignment(Qt.AlignCenter)
        theme.bind_style(self._src_path_lbl, lambda: f"background: {theme.BG_SURFACE}; border: 1px solid {theme.BORDER}; border-radius: 3px;"
        ...
        theme.bind_style(self.ref_drop, lambda self=self: self._drop_zone_card_style())
        ...
        theme.bind_style(ref_icon, lambda: f"font-size: 28px; color: {theme.TEXT_MUTED}; background: transparent; border: none;")
        ref_title_lbl = QLabel(get_text('ref_faces_label', self.lang)); ref_title_lbl.setAlignment(Qt.AlignCenter)
        theme.bind_style(ref_title_lbl, lambda: f"color: {theme.TEXT_PRIMARY}; font-size: {theme.fs(15)}; font-weight: 600; background: transparent; border: none;")
        ref_desc = QLabel(get_text('ref_faces_desc', self.lang))
        ref_desc.setAlignment(Qt.AlignCenter); ref_desc.setWordWrap(True)
        theme.bind_style(ref_desc, lambda: f"color: {theme.TEXT_SECONDARY}; font-size: {theme.fs(12)}; background: transparent; border: none;")
        self._ref_path_lbl = QLabel(get_text('no_ref_loaded', self.lang))
        self._ref_path_lbl.setAlignment(Qt.AlignCenter)
        theme.bind_style(self._ref_path_lbl, lambda: f"color: {theme.TEXT_SECONDARY}; font-size: {theme.fs(11)}; font-style: italic; background: transparent; border: none;")
        ...
        theme.bind_style(sc, lambda: f"QFrame {{ background: {theme.BG_CARD}; border: 1px solid {theme.BORDER_LIGHT}; border-radius: 10px; }}")
        ...
        theme.bind_style(sc_title_lbl, lambda: f"color: {theme.TEXT_PRIMARY}; font-size: {theme.fs(14)}; font-weight: 600;"
        ...
        theme.bind_style(self._thresh_val_lbl, lambda: f"color: {theme.ORANGE}; font-family: {theme.FONT_MONO}; font-size: {theme.fs(11)};"
            f" background: transparent; border: none;")
        ...
        theme.bind_style(self._thresh_sl, lambda self=self: self._slider_style())
        ...
        theme.bind_style(self._max_faces_spin, theme.spinbox)
        ...
        theme.bind_style(domain_toggle, lambda: f"QFrame {{ background: {theme.BG_DEEPEST}; border: 1px solid {theme.BORDER}; border-radius: 4px; }}")
        ...
        theme.bind_style(self._domain_real_btn, lambda self=self: self._domain_btn_style(True))
        theme.bind_style(self._domain_anime_btn, lambda self=self: self._domain_btn_style(False))
        ...
        theme.bind_style(self._dbscan_spin, theme.spinbox)
        ...
        theme.bind_style(div, lambda: f"background: {theme.BORDER}; border: none;"); div.setFixedHeight(1)
        ...
        theme.bind_style(self.start_btn, lambda: f"QPushButton {{ background: {theme.ORANGE}; color: #1a1a1a; font-weight: 700;"
        ...
        theme.bind_style(self.progress_bar, theme.progress_bar); self.progress_bar.setValue(0)
        ...
        theme.bind_style(self._results_title, lambda: f"color: {theme.TEXT_PRIMARY}; font-size: {theme.fs(18)}; font-weight: 700;"
        ...
        theme.bind_style(self._cluster_count_badge, lambda: f"background: {theme.BG_SURFACE}; color: {theme.TEXT_SECONDARY};"
        ...
        theme.bind_style(self._view_grid_btn, lambda: f'QPushButton {{ background: {theme.BG_SURFACE}; border: 1px solid {theme.BORDER}; border-radius: 4px; color: {theme.TEXT_PRIMARY}; padding: 4px 8px; font-size: 14px; }}')
        ...
        theme.bind_style(self._view_list_btn, lambda: f'QPushButton {{ background: transparent; border: 1px solid {theme.BORDER}; border-radius: 4px; color: {theme.TEXT_MUTED}; padding: 4px 8px; font-size: 14px; }}QPushButton:hover {{ color: {theme.TEXT_SECONDARY}; border-color: {theme.BORDER_LIGHT}; }}')
        self._view_grid_btn.clicked.connect(lambda: [
            theme.bind_style(self._view_grid_btn, lambda: f'QPushButton {{ background: {theme.BG_SURFACE}; border: 1px solid {theme.BORDER}; border-radius: 4px; color: {theme.TEXT_PRIMARY}; padding: 4px 8px; font-size: 14px; }}'),
            theme.bind_style(self._view_list_btn, lambda: f'QPushButton {{ background: transparent; border: 1px solid {theme.BORDER}; border-radius: 4px; color: {theme.TEXT_MUTED}; padding: 4px 8px; font-size: 14px; }}QPushButton:hover {{ color: {theme.TEXT_SECONDARY}; border-color: {theme.BORDER_LIGHT}; }}'),
        ])
        self._view_list_btn.clicked.connect(lambda: [
            theme.bind_style(self._view_list_btn, lambda: f'QPushButton {{ background: {theme.BG_SURFACE}; border: 1px solid {theme.BORDER}; border-radius: 4px; color: {theme.TEXT_PRIMARY}; padding: 4px 8px; font-size: 14px; }}'),
            theme.bind_style(self._view_grid_btn, lambda: f'QPushButton {{ background: transparent; border: 1px solid {theme.BORDER}; border-radius: 4px; color: {theme.TEXT_MUTED}; padding: 4px 8px; font-size: 14px; }}QPushButton:hover {{ color: {theme.TEXT_SECONDARY}; border-color: {theme.BORDER_LIGHT}; }}'),
        ])
        ...
        theme.bind_style(hline, lambda: f"background: {theme.BORDER}; border: none;"); hline.setFixedHeight(1)
        ...
        theme.bind_style(self._cluster_placeholder, lambda: f"color: {theme.TEXT_MUTED}; font-size: {theme.fs(13)}; background: transparent; border: none;")
    ...
    def _settings_label(self, text: str) -> QLabel:
        lbl = QLabel(text)
        theme.bind_style(lbl, lambda: f"color: {theme.TEXT_SECONDARY}; font-family: {theme.FONT_MONO}; font-size: {theme.fs(11)};"
    ...
    def _set_domain(self, mode: str):
        self._mode = mode
        is_real = (mode == 'real')
        theme.bind_style(self._domain_real_btn, lambda is_real=is_real, self=self: self._domain_btn_style(is_real))
        theme.bind_style(self._domain_anime_btn, lambda is_real=is_real, self=self: self._domain_btn_style(not is_real))
    ...
    def _build_preset_bar(self) -> QFrame:
        ...
        frame = QFrame()
        theme.bind_style(frame, theme.card_frame)
        lay = QHBoxLayout(frame)
        lay.setSpacing(12)

        self._preset_type_lbl = QLabel(get_text('char_model_type', self.lang))
        theme.bind_style(self._preset_type_lbl, theme.label_default)
        ...
        theme.bind_style(self._preset_real_btn, lambda self=self: self._preset_btn_style(active=True))
        ...
        theme.bind_style(self._preset_anime_btn, lambda self=self: self._preset_btn_style(active=False))
        ...
        theme.bind_style(self._preset_info_lbl, theme.label_muted)
    ...
    def _apply_preset(self, key: str):
        ...
        theme.bind_style(self._preset_real_btn, lambda key=key, self=self: self._preset_btn_style(key == 'real'))
        theme.bind_style(self._preset_anime_btn, lambda key=key, self=self: self._preset_btn_style(key == 'anime'))
    ...
    def _build_folder_step(self) -> QFrame:
        ...
        theme.bind_style(self.step1_title, theme.label_section)
        ...
        theme.bind_style(self.input_lbl, theme.label_default)

        self.browse_input_btn = QPushButton(get_text('char_browse_input', self.lang))
        theme.bind_style(self.browse_input_btn, theme.btn_browse)
        ...
        theme.bind_style(self.input_count_lbl, theme.label_success)
        ...
        theme.bind_style(self.ref_status_lbl, theme.label_muted)
        ...
        theme.bind_style(self.out_lbl, theme.label_default)
        ...
        theme.bind_style(self.clear_out_btn, theme.btn_danger)
    ...
    def _build_settings_step(self) -> QFrame:
        ...
        theme.bind_style(self.step2_title, theme.label_section)
        ...
        theme.bind_style(self.thresh_lbl, theme.label_frame)
        self.thresh_lbl_info = QLabel("ℹ️")
        theme.bind_style(self.thresh_lbl_info, theme.info_icon_frame)
        ...
        theme.bind_style(self.thresh_spin, theme.spinbox)
        ...
        theme.bind_style(self.eps_lbl, theme.label_frame)
        self.eps_info = QLabel("ℹ️")
        theme.bind_style(self.eps_info, theme.info_icon_frame)
        ...
        theme.bind_style(self.eps_spin, theme.spinbox)

        self.min_lbl = QLabel(get_text('char_cluster_min', self.lang))
        theme.bind_style(self.min_lbl, theme.label_frame)
        self.min_info = QLabel("ℹ️")
        theme.bind_style(self.min_info, theme.info_icon_frame)
        ...
        theme.bind_style(self.min_spin, theme.spinbox)
        ...
        theme.bind_style(self.max_char_lbl, theme.label_frame)
        self.max_char_info = QLabel("ℹ️")
        theme.bind_style(self.max_char_info, theme.info_icon_frame)
        ...
        theme.bind_style(self.max_char_slider, theme.slider)

        self.max_char_value_lbl = QLabel("6")
        self.max_char_value_lbl.setFixedWidth(20)
        theme.bind_style(self.max_char_value_lbl, theme.label_value)
        ...
        theme.bind_style(ticks_lbl, lambda: f"color: {theme.TEXT_MUTED}; font-size: {theme.fs(10)};")
        ...
        theme.bind_style(self.topn_lbl, theme.label_frame)
        self.topn_info = QLabel("ℹ️")
        theme.bind_style(self.topn_info, theme.info_icon_frame)
        ...
        theme.bind_style(self.topn_spin, lambda: theme.spinbox() if hasattr(theme, 'spinbox') else "")
    ...
    def _build_start_step(self) -> QFrame:
        ...
        theme.bind_style(self.step3_title, theme.label_section)
        lay.addWidget(self.step3_title)

        btn_row = QHBoxLayout()
        self.start_btn = QPushButton(get_text('char_start_btn', self.lang))
        self.start_btn.setEnabled(False)
        theme.bind_style(self.start_btn, theme.btn_primary)
        self.start_btn.clicked.connect(self._start)
    ...
    def _set_input(self, path: str):
        ...
        if hasattr(self, '_src_path_lbl'):
            ...
            theme.bind_style(self._src_path_lbl, lambda: f"background: {theme.BG_SURFACE}; border: 1px solid {theme.ORANGE}44;"
                f" border-radius: 3px; color: {theme.ORANGE_LIGHT};"
                f" font-family: {theme.FONT_MONO}; font-size: {theme.fs(10)}; padding: 2px 8px;")
            theme.bind_style(self.input_drop, lambda: f"QFrame {{ background: {theme.BG_SURFACE}; border: 1px dashed {theme.ORANGE};"
                f" border-radius: 8px; }}")
    ...
    def _set_ref(self, path: str):
        ...
        if hasattr(self, '_ref_path_lbl'):
            ...
            theme.bind_style(self._ref_path_lbl, lambda: f"color: {theme.ORANGE_LIGHT}; font-size: {theme.fs(10)};"
                f" font-style: normal; background: transparent; border: none;")
            theme.bind_style(self.ref_drop, lambda: f"QFrame {{ background: {theme.BG_SURFACE}; border: 1px dashed {theme.ORANGE};"
                f" border-radius: 8px; }}")
    ...
    def _set_output(self, path: str):
        ...
        lbl.setText(display)
        theme.bind_style(lbl, theme.label_success)
        theme.bind_style(self.out_drop, theme.drop_zone_frame_success)
        ...
        theme.bind_style(self.out_status_lbl, theme.label_success)
    ...
    def _clear_ref(self):
        ...
        theme.bind_style(lbl, theme.label_transparent)
        theme.bind_style(self.ref_drop, theme.drop_zone_frame_default)
    ...
    def _clear_output(self):
        ...
        theme.bind_style(lbl, theme.label_transparent)
        theme.bind_style(self.out_drop, theme.drop_zone_frame_default)
    ...
    def _populate_cluster_grid(self, stats: Dict):
        ...
        if not stats:
            ...
            self._cluster_placeholder.setAlignment(Qt.AlignCenter)
            theme.bind_style(self._cluster_placeholder, lambda: f"color: {theme.TEXT_MUTED}; background: transparent; border: none;")
            self._cluster_grid_lay.addWidget(self._cluster_placeholder, 0, 0)
    ...
    def _make_cluster_card(self, name: str, count: int, confidence: float = 0.0) -> QFrame:
        ...
        theme.bind_style(card, lambda is_noise=is_noise, is_named=is_named: f"QFrame {{ background: {theme.BG_SURFACE}; border: 1px solid {('#7f1d1d' if is_noise else theme.ORANGE + '55' if is_named else theme.BORDER)};"
        ...
        theme.bind_style(mosaic, lambda: f"background: {theme.BG_DEEPEST}; border: none;")
        ...
        theme.bind_style(img_badge, lambda: f"background: rgba(0,0,0,0.7); color: {theme.TEXT_SECONDARY};"
        ...
        # Info section
        info = QFrame()
        theme.bind_style(info, lambda: f"QFrame {{ background: {theme.BG_SURFACE}; border: none;"
        ...
        theme.bind_style(name_lbl, lambda is_noise=is_noise, is_named=is_named: f"color: {('#f87171' if is_noise else theme.ORANGE if is_named else theme.TEXT_PRIMARY)}; font-weight: 600; font-size: {theme.fs(11)};"
            f" background: transparent; border: none;")
        name_lbl.setWordWrap(False)
        name_row.addWidget(name_lbl, stretch=1)
        edit_icon = QLabel("✏" if not is_noise else "🗑")
        theme.bind_style(edit_icon, lambda: f"color: {theme.TEXT_MUTED}; font-size: 10px; background: transparent; border: none;")
        ...
        theme.bind_style(conf_lbl, lambda is_noise=is_noise: f"color: {'#7f1d1d' if is_noise else theme.TEXT_MUTED}; font-size: {theme.fs(9)};"
