...
def upscale_model_path(filename: str) -> Path:
    """Return absolute path for an upscale model file, e.g. 'RealESRGAN_x4plus.pth'."""
    ensure_dirs()
    return UPSCALE_DIR / filename
